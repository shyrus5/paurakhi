...
class All extends StatefulWidget {
  ...
  const All({Key? key, required this.category, required this.type})
      : super(key: key);
...
class AllState extends State<All> {
  ...
  Future<void> _getProducts({required bool clearItems}) async {
    ...
    final ServerResponseProduct? response =
        await GetProductAPI.getProductCategory(
      widget.category,
      widget.type,
            ...
            Column(
              children: [
                ...
                SizedBox(
                    height: 80,
                    width: 80,
                    child: Image.asset('assets/images/paurakhi.gif')),
              ],
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      isLoading ? Colors.grey : AppColors.textGreen,
                ),
...
class All1 extends StatefulWidget {
  ...
  const All1({Key? key, required this.category, required this.type})
      : super(key: key);
